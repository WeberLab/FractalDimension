...
for jake=1:100
    ...
    diff=abs(FDmapRDall-rndn);
    rdlst(jake,:)=[rndn FDmapRDall diff];
    ...
    diff=abs(hurstPS-rndn);
    pslst(jake,:)=[rndn hurstPS diff];
