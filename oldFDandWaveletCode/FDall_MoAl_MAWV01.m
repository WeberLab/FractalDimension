% for me to do: automation and ROI with masking
% for alex to do: fix component section and ROI other than masking
...
if ROIyes=='y',
    ...
    elseif ROItype=='m'
        ...
        % % MAW_Jan2011: mask should be an AFNI file that is single sliced and matched the resolution of the BOLD data
        % % this can be done using 3dresample eg: 3dresample -master FD_6447+orig -prefix mask_resample_6447 -inset mask_6447+orig
        ...
        [mask_err,MASK,mask_Info,mask_ErrMessage]=BrikLoad(maskfile); % % MAW_Jan2011 imports mask as matrix with ROIs (value is 1, 2, 3...) which can be separated into three matrixes if needed
        % % begin with assumption that there is only one ROI (value would be = 1)
