for goo=9:11
    ...
    if ROIyes=='y',
        ...
        if automation=='n'              % MAW
            if goo==3;
                ...
                elseif ROItype=='d'
                    ...
                    eval(['save ' num2str(FDdir) '_ROI BW newROIsize;']);
        ...
        eval(['save ' num2str(FDdir) '_' ROIname '_bins_' num2str(bins) '_roistats.txt' ' statsdata -ASCII;']);
