...
if gofig == 'y',
   ...
   delete(1);
    ...
    if doComponents=='y'
        ...
        for a=1:ZZ;  % % MoAl_Jan2011 %Alchanged
            ...
            eval(['print -f1 -dpsc -r1200 ' num2str(FDdir) '_FD_Slice' num2str(a+Za-1) ' ;']); %Alchanged
...
if doComponents=='y'&& ROIyes=='y' %%Alchanged
...
elseif doComponents=='y'%%Alchanged
    eval(['save ' num2str(FDdir) '_variables_V2 FDmapRDslow FDmapRDfast FDmapRDslow_interp FDmapRDfast_interp, ''-append'';']);%%Alchanged
end
if ROIyes=='y'
    eval(['save ' num2str(FDdir) '_variables_V2 statsdata ROI_all_interp, ''-append'';']); %%Alchanged
end
