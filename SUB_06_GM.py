...
grey_matter = 'Masks_SUB_06/greymatter.nii.gz'
...
gm_mask = 'Masks_SUB_06/greymattermask.nii.gz'
...
Hurst_fig.savefig('Masks_SUB_06/Results/Hurst_Heatmap_SUB_06_GM_Slice28.png')
plt.close(Hurst_fig)
...
Class_fig.savefig('Masks_SUB_06/Results/Class_Heatmap_SUB_06_GM_Slice28.png')
plt.close(Class_fig)
