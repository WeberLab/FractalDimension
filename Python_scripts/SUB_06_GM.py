...
Hurst_map = sns.heatmap(Hurst_matrix, mask = gm_mask_inv)
Hurst_fig = Hurst_map.get_figure()
Hurst_fig.suptitle('Hurst Coefficient')
Hurst_fig.savefig('SUB_06_GM_Slice20_Hurst.png')
plt.close(Hurst_fig)
...
Class_map = sns.heatmap(Class_matrix, mask = gm_mask_inv)
Class_fig = Class_map.get_figure()
Class_fig.suptitle('Class')
Class_fig.savefig('SUB_06_GM_Slice20_Class.png')
plt.close(Class_fig)
