...
def MAE_calc(i):
    ...
    global diff
    result = FracTool_Current.FracTool(raw_sig[i][0:3599]) #run Fractool on each signal in signal array
    #each signal is spliced from 0 to 3599 to have length 3600
