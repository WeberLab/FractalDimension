...
grey_matter = 'Masks_SUB_06/whitematter.nii.gz'
...
gm_mask = 'Masks_SUB_06/whitemattermask.nii.gz'
gm_img = nib.load(gm_mask, mmap=False)
gm_array = gm_img.get_fdata()
gm_sq = gm_array[:,:,28].flatten()
...
Hurst_fig.savefig('Masks_SUB_06/Results/Hurst_Heatmap_SUB_06_WM_Slice28.png')
plt.close(Hurst_fig)
...
Class_fig.savefig('Masks_SUB_06/Results/Class_Heatmap_SUB_06_WM_Slice28.png')
plt.close(Class_fig)
